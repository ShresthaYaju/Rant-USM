...
function Post(props) {
  ...
  return (
    <div className="px-40 my-12">
      <div
        className={`border-2 border-gray-600 bg-gray-800 p-9 pr-5 group hover:border-gray-400 duration-300 rounded-xl flex flex-1 cursor-pointer `}
      >
        <div className="text-center w-11/12 border-r-2 border-gray-600 group-hover:border-gray-400 duration-300 select-none">
          {Data ? (
